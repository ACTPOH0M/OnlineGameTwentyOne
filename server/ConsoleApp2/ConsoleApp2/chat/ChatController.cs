...
namespace ConsoleApp2
{
    public static class ChatController
    {
        ...
        public static void AddMessage(string userName, string msg)
        {
            ...
            catch (Exception exp) { Console.WriteLine("Error with addMessage: {0}.", exp.Message); ErrorLog.Log(DateTime.Now + " Error with addMessage: " + exp.Message); }
        }
        ...
        public static string GetChat()
        {
            ...
            catch (Exception exp) { Console.WriteLine("Error with getChat: {0}", exp.Message); ErrorLog.Log(DateTime.Now + " Error with getChat: " + exp.Message); return string.Empty; }
        }
    }
}
